...
async function main() {
    ...
    console.log(chalk.magentaBright(`\t \t ${heroInfo.name.toUpperCase()} v/s ${opponentInfo.name.toUpperCase()}`));
    ...
    while (heroInfo.health > 0 && opponentInfo.health > 0) {
        ...
        switch (action.Action) {
            case "Attack":
                let oppDamage = Math.floor(Math.random() * 35 + 1); // Generates a random number between 1 and 35
                let heroDamage = Math.floor(Math.random() * 35 + 1); // Generates a random number between 1 and 35
            ...
            case "Defend":
                ...
                break;
            case "Heal":
                let oppDamage2 = Math.floor(Math.random() * 35 + 1); // Generates a random number between 1 and 35
                let heroDamage2 = Math.floor(Math.random() * 35 + 1); // Generates a random number between 1 and 35
